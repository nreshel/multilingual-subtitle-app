...
output_csv = 'spectrogram_flattend_image_next_10000_data.csv'
...
with open(output_csv, mode='w', newline='') as file:
    ...
    for language in os.listdir(base_dir):
        ...
        if os.path.isdir(language_dir):
            ...
            for index, filename in enumerate(os.listdir(language_dir)):
                # Skip the first 10,000 images and start from the next 10,000
                if index < 10000:
                    continue
                ...
                if filename.endswith(('.png', '.jpg', '.jpeg')) and count < 10000:
                    ...
                    try:
                        ...
                        with Image.open(image_path) as img:
                            ...
                            print(f"Processed {index + 1} images in {language}")
